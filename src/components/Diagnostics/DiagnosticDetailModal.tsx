    ...
    return (
        <div className="space-y-4" ref={ref}>
            ...
            <div className="flex justify-end">
                <div className="bg-blue-600 text-white p-3 rounded-lg max-w-full sm:max-w-xl shadow-sm">
            ...
            <div className="flex justify-start">
                <div className={`p-3 rounded-lg max-w-full sm:max-w-xl shadow-sm
...
const DiagnosticDetailModal: FC<DiagnosticDetailModalProps> = ({ 
    ...
    return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
            {/* Modal panel */}
            <div className="bg-white rounded-lg shadow-2xl w-full max-w-full sm:max-w-2xl lg:max-w-4xl h-[90vh] flex flex-col">
                
                {/* --- Modal Header --- */}
                <div className="flex justify-between items-center p-4 border-b border-gray-200 flex-wrap gap-2">
                    <div>
                    ...
                    <button onClick={onClose} className="p-2 rounded-full text-gray-400 hover:bg-gray-100 min-w-[44px] min-h-[44px] flex items-center justify-center">
                        <X className="w-5 h-5" />
                    </button>
                </div>
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-2">
                            <select
                                ...
                                className="block w-full sm:max-w-xs p-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 disabled:opacity-70"
                            >
                        ...
                        <div className="flex flex-col sm:flex-row gap-2">
                            ...
                            <button
                                ...
                                className="w-full sm:w-auto px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700
                                           flex items-center justify-center disabled:opacity-50 self-end"
                            >
                                {isSubmittingNote ? (
                                    <Loader2 className="w-5 h-5 animate-spin" />
                                ) : (
                                ...
                                <span className="ml-2 sm:hidden">Add Note</span>
                            </button>
                        </div>
                    </form>
                </div>
