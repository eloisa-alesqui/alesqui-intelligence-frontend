...
const Section: React.FC<SectionProps> = ({ title, icon: Icon, children }) => (
    <div className="border border-gray-200/80 bg-white rounded-lg shadow-sm">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200/80">
        ...
        <div className="space-y-8">
            ...
            {showGroupSelector && (
                <Section title="Group Assignment" icon={Users}>
                    <div>
                        ...
                        <div className="space-y-2 max-h-60 overflow-y-auto border border-gray-200 rounded-md p-4 bg-gray-50 custom-scrollbar">
            ...
            <Section title="Authentication" icon={Lock}>
                ...
                {config.auth.authType !== 'none' && (
                    <div className="mt-6 p-3 sm:p-5 bg-slate-50 rounded-md space-y-4 border border-slate-200">
