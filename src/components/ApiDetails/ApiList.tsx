...
import { Search, Server, Calendar, Users, Globe, Settings, RefreshCw, Trash2, ToggleLeft, ToggleRight } from 'lucide-react';
    ...
    return (
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="flex justify-between items-center">
                ...
                <button
                    onClick={loadApis}
                    className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center gap-2 min-w-[44px] min-h-[44px]"
                >
                    <RefreshCw size={16} />
                        ...
                        <div key={api.id} className={`bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all flex flex-col ${
                            ...
                            <div className="p-6 flex-1">
                                ...
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex-1">
                                        <h3 className="text-lg font-semibold text-gray-900 mb-1 truncate" title={api.name}>
                                            {api.name}
                                        </h3>
                                        {api.version && (
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button
                                            ...
                                            className={`p-2 min-w-[44px] min-h-[44px] flex items-center justify-center ${ApiUtils.canModifyApi(api, user?.sub, user?.authorities) ? 'cursor-pointer' : 'cursor-not-allowed opacity-50'}`}
                            ...
                            <div className="px-6 py-3 bg-gray-50 border-t border-gray-100 flex justify-between">
                                <button 
                                    ...
                                    className="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center gap-1 min-h-[44px] inline-flex items-center"
                                >
                                    <Settings size={14} />
                                    Manage
                                </button>
