        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6 flex items-start justify-between">
                <div className="space-y-1 min-w-0">
                    <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3 min-w-0">
                        <User className="w-6 h-6 text-blue-600 flex-shrink-0" />
                        <span className="truncate">{data.username}</span>
                        {isCurrentUser && (
                            <span className="text-sm bg-green-100 text-green-800 px-2 py-1 rounded border border-green-200 flex-shrink-0">(You)</span>
                        )}
                    </h1>
                </div>
            </div>
