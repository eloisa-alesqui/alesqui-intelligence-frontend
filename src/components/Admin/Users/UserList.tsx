        ...
        return (
            <>
                ...
                <div className="md:hidden space-y-3">
                    {filtered.map(u => (
                        <div key={u.id} className="bg-white border border-gray-200 rounded-lg shadow-sm p-4 space-y-3">
                            <div className="flex items-center gap-2">
                                <Mail className="w-4 h-4 text-gray-400 flex-shrink-0" />
                                <span className="text-sm font-medium text-gray-900 truncate">{u.username}</span>
                                {isCurrentUser(u) && (
                                    <span className="text-xs bg-rose-100 text-rose-800 px-2 py-0.5 rounded border border-rose-200 flex-shrink-0">(You)</span>
                                )}
                            </div>
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="text-xs text-gray-500">{u.groupCount ?? 0} groups</span>
                            </div>
                            <div className="flex gap-2 border-t border-gray-100 pt-3">
                                ...
                                <button
                                    ...
                                    className={`flex-1 text-center text-sm font-medium rounded-md py-2 transition-colors ${!canDelete(u) ? 'text-gray-400 bg-gray-50 cursor-not-allowed' : 'text-red-700 bg-red-50 hover:bg-red-100'}`}
                                    title={
                                        isCurrentUser(u)
                    ...
                    <table className="w-full divide-y divide-gray-200">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-3 md:px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Groups</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {filtered.map(u => (
                                <tr key={u.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-3 md:px-6 py-4 whitespace-nowrap text-sm text-gray-700 text-center">{u.groupCount ?? 0}</td>
            ...
            >
                ...
                <div className="relative w-full md:w-48">
                    ...
                    <select
                        ...
                        className="w-full pl-10 pr-9 p-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 appearance-none"
                    >
