                                    ...
                                    <div className="fixed inset-0 z-50">
                                        ...
                                        <div className="absolute right-0 top-0 h-full w-full max-w-2xl bg-white shadow-xl border-l border-gray-200 flex flex-col">
                                            ...
                                            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                                                ...
                                                <button className="p-2 rounded-md text-gray-400 hover:bg-gray-100 hover:text-gray-700 min-w-[44px] min-h-[44px] flex items-center justify-center" onClick={() => !assigning && setAssignOpen(false)}>
                                                    <X className="w-5 h-5" />
                                                </button>
                                            </div>
                                            {/* Controls */}
                                    ...
                                    <div className="fixed inset-0 z-50">
                                        ...
                                        <div className="absolute right-0 top-0 h-full w-full max-w-xl bg-white shadow-xl border-l border-gray-200 flex flex-col">
                                            ...
                                            <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                                                ...
                                                <button className="p-2 rounded-md text-gray-400 hover:bg-gray-100 hover:text-gray-700 min-w-[44px] min-h-[44px] flex items-center justify-center" onClick={() => !userAssignAssigning && setUserAssignOpen(false)}>
                                                    <X className="w-5 h-5" />
                                                </button>
                                            </div>
                                            {/* Controls */}
