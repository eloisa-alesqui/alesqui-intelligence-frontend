...
const ConversationHistory: FC<ConversationHistoryProps> = ({
    ...
    return (
        <div className="bg-gray-50 h-full flex flex-col border-r border-gray-200 w-full">
                            ...
                            return (
                                <li key={conv.conversationId} className="group relative">
                                    ...
                                    <button
                                        ...
                                        className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-full text-gray-400 hover:bg-red-100 hover:text-red-600 opacity-0 group-hover:opacity-100 transition-opacity touch-visible min-w-[44px] min-h-[44px] flex items-center justify-center"
